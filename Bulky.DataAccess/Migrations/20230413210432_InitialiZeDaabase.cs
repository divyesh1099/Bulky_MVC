...
{
    /// <inheritdoc />
    public partial class InitialiZeDaabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderHeaqderId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Count = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_OrderHeaders_OrderHeaqderId",
                        column: x => x.OrderHeaqderId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Navi Mumbai", "Zeus", "9988776655", "400709", "Maharashtra", "SS1, Sector-15, Room No 561, Koparkhairane" },
                    { 2, "Navi Mumbai", "Infosys", "9998887776", "400709", "Maharashtra", "SS1, Sector-15, Room No 561, Koparkhairane" },
                    { 3, "Navi Mumbai", "Kelp", "9999888877", "400709", "Maharashtra", "SS1, Sector-15, Room No 561, Koparkhairane" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_OrderHeaqderId",
                table: "OrderDetails",
                column: "OrderHeaqderId");
